...
import com.tenforwardconsulting.cordova.bgloc.data.PreferenceHelper;
...
public class BackgroundGeolocationPlugin extends CordovaPlugin {
    ...
    public static final String ACTION_START_DISTANCE_CALCULATION = "startDistanceCalculation";
    public static final String ACTION_STOP_DISTANCE_CALCULATION = "stopDistanceCalculation";
    public static final String ACTION_GET_DISTANCE_TRAVELLED = "getDistanceTravelled";
    ...
    public boolean execute(String action, JSONArray data, CallbackContext callbackContext) {
        ...
        else if(ACTION_START_DISTANCE_CALCULATION.equals(action)){
            Log.d("beta","Starating tracking ");
            helper.saveFloat(PreferenceHelper.DISTANCE_IN_KM,0);
            helper.startDistanceCalculation();
            return true;
        }
        else if(ACTION_STOP_DISTANCE_CALCULATION.equals(action)){
            helper.stopDistanceCalculation();

            return true;
        }
        else if(ACTION_GET_DISTANCE_TRAVELLED.equals(action)){
            float distanceTravelled=helper.getTravelledDistance();
            callbackContext.success(convertToTwoDecimalPlaces(distanceTravelled)+"");
            return true;
        }
    ...
    public String convertToTwoDecimalPlaces(double value) {
