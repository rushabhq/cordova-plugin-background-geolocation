...
public class FusedLocationService extends AbstractLocationService implements GoogleApiClient.ConnectionCallbacks,
    ...
    public void onLocationChanged(Location location) {
        ...
        Log.d("beta","Starating tracking "+preferenceHelper.isDistanceToBeCalculated());
        Log.d("beta","Last location null "+(lastLocation==null));
        if (lastLocation != null && preferenceHelper.isDistanceToBeCalculated()) {

            float distance = location.distanceTo(lastLocation);


            float travelledDistance = preferenceHelper.getFloat(PreferenceHelper.DISTANCE_IN_KM, 0);


            travelledDistance += distance/1000;


            Log.d(TAG,"Travlled distance "+travelledDistance+" KM");
            preferenceHelper.saveFloat(PreferenceHelper.DISTANCE_IN_KM,travelledDistance);
